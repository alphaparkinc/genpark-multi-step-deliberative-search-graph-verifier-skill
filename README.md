# genpark-multi-step-deliberative-search-graph-verifier-skill
...
> **GenPark AI Agent Skill** -- Multi-step deliberative reasoning search graph verifier (Perplexity Pro style)
